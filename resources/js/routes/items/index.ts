...
* @see app/Http/Controllers/ItemController.php:364
...
* @see app/Http/Controllers/ItemController.php:328
* @route '/items/{item}'
*/
...
const items = {
    ...
    maintenanceEntries: Object.assign(maintenanceEntries, maintenanceEntries),
}
