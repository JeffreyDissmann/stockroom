...
const RedirectControllera4e2100d8f0eafc607b8e611fcc637d8 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: RedirectControllera4e2100d8f0eafc607b8e611fcc637d8.url(options),
    method: 'get',
})

RedirectControllera4e2100d8f0eafc607b8e611fcc637d8.definition = {
    methods: ["get","head","post","put","patch","delete","options"],
    url: '/household',
} satisfies RouteDefinition<["get","head","post","put","patch","delete","options"]>
...
RedirectControllera4e2100d8f0eafc607b8e611fcc637d8.url = (options?: RouteQueryOptions) => {
    return RedirectControllera4e2100d8f0eafc607b8e611fcc637d8.definition.url + queryParams(options)
}
