...
* @see app/Http/Controllers/Api/V1/HomeAssistantLinkController.php:20
...
* @see app/Http/Controllers/Api/V1/HomeAssistantLinkController.php:30
* @route '/api/v1/items/{item}/home-assistant-link'
*/
...
const HomeAssistantLinkController = { update, destroy }
