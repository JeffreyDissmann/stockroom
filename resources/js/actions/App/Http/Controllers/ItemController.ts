...
* @see app/Http/Controllers/ItemController.php:157
...
* @see app/Http/Controllers/ItemController.php:169
* @route '/items/{item}'
*/
...
const ItemController = { moveTargets, move, index, create, store, show, edit, update, destroy }
