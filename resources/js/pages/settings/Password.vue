            ...
            <div class="space-y-6">
                ...
                <form @submit.prevent="updatePassword" class="space-y-6">
                    <div class="grid gap-2">
                        <Label for="current_password">{{ $t('settings.password.current_label') }}</Label>
                        <Input
                            id="current_password"
                    ...
                    <div class="grid gap-2">
                        <Label for="password">{{ $t('settings.password.new_label') }}</Label>
                        <Input
                            id="password"
                            ref="passwordInput"
                    ...
                    <div class="grid gap-2">
                        <Label for="password_confirmation">{{ $t('settings.password.confirm_label') }}</Label>
                        <Input
