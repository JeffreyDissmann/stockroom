...
return [
    ...
    'bulk' => [
        'select' => 'Auswählen',
        'done' => 'Fertig',
        'count' => ':count ausgewählt|:count ausgewählt',
        'delete' => 'Löschen',
        'delete_confirm' => ':count Gegenstand löschen? Enthaltene Elemente werden auf die oberste Ebene verschoben.|:count Gegenstände löschen? Enthaltene Elemente werden auf die oberste Ebene verschoben.',
        'move' => 'Verschieben',
        ...
        'attach_tag_title' => 'Schlagwort hinzufügen',
        'attach_tag_description' => 'Ein Schlagwort an :count Gegenstand anhängen.|Ein Schlagwort an :count Gegenstände anhängen.',
        'detach_tag' => 'Schlagwort entfernen',
        'detach_tag_title' => 'Schlagwort entfernen',
        'detach_tag_description' => 'Ein Schlagwort von :count Gegenstand entfernen.|Ein Schlagwort von :count Gegenständen entfernen.',
    ],
];
